...
bin\openssl req -config AICA.cfg -new -sha256 -key %1.key -out %1.csr

REM -- Sign it with Infrastructure CA
bin\openssl ca -config AICA.cfg -batch -notext -extensions ext_server -days 1825 -in %1.csr -out %1.crt
